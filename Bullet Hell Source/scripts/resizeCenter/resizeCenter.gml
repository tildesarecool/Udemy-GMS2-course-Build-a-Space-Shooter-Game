...
function resizeCenter( targetView ) {
	...
	window_set_rectangle( (display_get_width() - view_wport[targetView]) * 0.5, (display_get_height() - view_hport[targetView]) * 0.5, view_wport[targetView], view_hport[targetView]  );
	// resize the surface
